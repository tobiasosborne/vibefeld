...
Workflow:
  ...
  Use 'af release' if you cannot complete the work.`,
	...
	cmd.Flags().StringP("timeout", "t", service.DefaultClaimTimeout, "Claim timeout duration (e.g., 30m, 1h, 2h30m)")
